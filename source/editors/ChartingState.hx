...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Bomb', 'aaa'],
		['Burn', 'aaa'],
		['Black Stuff', 'it just happens'],
		['Remove Black', 'it just happens'],
		['Light', 'flash'],
		['Black Bars', 'Value 1 = Speed\nValue 2 = Distance'],
		...
		['Flashback', "Exclusive a fallout song.\nValue 1: 1 = Flashback, 2 = Return"],
		['Screen Shake', "Value 1: Camera shake\nValue 2: HUD shake\n\nEvery value works as the following example: \"1, 0.05\".\nThe first number (1) is the duration.\nThe second number (0.05) is the intensity."],
		['camBeatHit', 'Value 1: Camera Beat\nValue 2: NO DO NOT CLICK THIS GAME CRASH OR ...'],
		...
		['boomnodisarm', 'aa'],
		['3rdstrum', 'lol'],
		['Cam Zoom Tween', "Smoothly changes the\ncamera's zoom.\nValue 1: Target zoom\nValue 2: Duration (0 = Instant)"],
		['Health Drain', 'Value 1 = How much health to drain when opponent sings (0.5 is recommended)']
	];
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		#if MODS_ALLOWED
		directories.push(Paths.mods('luanotetypes/'));
		directories.push(Paths.mods(Paths.currentModDirectory + '/luanotetypes/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.mods(mod + '/luanotetypes/'));
		#end
	...
	function addEventsUI():Void
	{
		...
		#if MODS_ALLOWED
		directories.push(Paths.mods('luaevents/'));
		directories.push(Paths.mods(Paths.currentModDirectory + '/luaevents/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.mods(mod + '/luaevents/'));
		#end
