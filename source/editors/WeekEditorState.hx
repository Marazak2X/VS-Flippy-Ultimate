...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	//private var flipArray:Array<FlxSprite> = [];
	var bg:FlxSprite;
	...
	override function create() {
		...
		/*flipbg = new FlxSprite().loadGraphic(Paths.image('freeplay/fallen-soilder/og-bg'));
		flipbg.antialiasing = ClientPrefs.globalAntialiasing;
		add(flipbg);

		flipps = new FlxSprite().loadGraphic(Paths.image('freeplay/fallen-soilder/og-fg'));
		flipps.screenCenter();
		flipps.antialiasing = ClientPrefs.globalAntialiasing;
		add(flipps);

		flipArray.push(flipps);
		flipArray.push(flipbg);*/
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>) {
		if(id == FlxUIInputText.CHANGE_EVENT && (sender is FlxUIInputText)) {
			...
			//weekFile.songs[curSelected][1] = showInputText.text;
			//flipArray[curSelected].loadGraphic('freeplay/fallen-soilder/' + showInputText.text + '-bg');
	...
	public static var freeplayShow:String;
	...
	//var showInputText:FlxUIInputText;
	function addFreeplayUI() {
		...
		//showInputText = new FlxUIInputText(100, bgColorStepperR.y + 70, 100, '', 8);
		...
		//tab_group.add(new FlxText(100, showInputText.y - 18, 0, 'Show Freeplay:'));
	...
	function changeSelection(change:Int = 0) {
		...
		*/
		...
		//showInputText.text = weekFile.songs[curSelected][1];
	...
	override function update(elapsed:Float) {
		...
		{
			case 'og':
				flipbg.loadGraphic('assets/images/freeplay/fallen-soilder/$freeplayShow-bg');
				flipps.loadGraphic('assets/images/freeplay/fallen-soilder/$freeplayShow-fg');
			case 'bloody':
				flipbg.loadGraphic('assets/images/freeplay/fallen-soilder/$freeplayShow-bg');
				flipps.loadGraphic('assets/images/freeplay/fallen-soilder/$freeplayShow-fg');
			case 'insane':
			...
			case 'shanked':
				...
				flipps.loadGraphic('assets/images/freeplay/fallen-soilder/$freeplayShow-fg');
			default:
				flipbg.loadGraphic('assets/images/freeplay/default');
				flipps.loadGraphic('assets/images/credits/blank');
		}*/
