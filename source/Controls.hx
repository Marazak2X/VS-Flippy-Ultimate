	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.KEY5, keysMap.get('key5'));
			...
			case Duo(true):
				...
				inline bindKeys(Control.FULLSCREEN, [F]);
		...
		switch (scheme)
		{
			case Solo:
				...
				bindKeys(Control.KEY5, [SPACE, SHIFT]);
				bindKeys(Control.ACCEPT, [Z, SPACE, ENTER]);
				bindKeys(Control.FULLSCREEN, [F]);
