...
class ClientPrefs {
	...
	public static var ratingMissHealth:Bool = true;
	...
	public static var freeplayMenu:String = 'Original';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.freeplayMenu = freeplayMenu;
		FlxG.save.data.camZooms = camZooms;
		FlxG.save.data.ratingMissHealth = ratingMissHealth;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.ratingMissHealth != null) {
			ratingMissHealth = FlxG.save.data.ratingMissHealth;
		}
		...
		if(FlxG.save.data.freeplayMenu != null) {
			freeplayMenu = FlxG.save.data.freeplayMenu;
		}
